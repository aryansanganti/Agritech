                    ...
                    <div className="text-center space-y-4">
                        ...
                        <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-xl text-left text-sm space-y-2 font-mono border border-dashed border-gray-300 dark:border-gray-700">
                            <div className="flex justify-between">
                                ...
                                <span className="text-bhoomi-green truncate max-w-[150px]">{selectedListing.blockchainHash}</span>
                            </div>
                            <div className="flex justify-between">
                        ...
                        <div className="py-4">
                            ...
                            <div className="w-48 h-48 bg-white p-2 mx-auto border-4 border-gray-900 rounded-lg">
                                ...
                                <div className="w-full h-full bg-[url('https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=agritechVerified')] bg-contain bg-no-repeat bg-center"></div>
                            </div>
            ...
            <div className="p-4 md:p-6 max-w-7xl mx-auto">
                ...
                {role === 'farmer' && (
                    <div className="animate-fade-in">
                        <div className="glass-panel p-8 text-center border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-2xl hover:border-bhoomi-green transition-colors cursor-pointer group mb-8">
...
const ListingCard: React.FC<{ item: Listing, isOwner: boolean, onViewQR: () => void }> = ({ item, isOwner, onViewQR }) => {
    ...
    return (
        <div className="glass-panel rounded-2xl overflow-hidden group hover:shadow-xl transition-all duration-300 border border-transparent hover:border-bhoomi-green/30">
            {/* Image Header */}
